...
export type AppView = 'HUB' | 'TIMER' | 'FLASHCARDS' | 'FLASHCARD_MANAGER' | 'FLASHCARD_STUDY' | 'AI_DIRECT' | 'MATERIALS' | 'QUIZ_PLAYER' | 'TDH_QUESTOES' | 'STUDY_PLAN' | 'PROFILE' | 'COMMUNITY' | 'FOCUS_MODE' | 'STUDY_MATERIALS';
