...
const MaterialUploadModal: React.FC<MaterialUploadModalProps> = ({ onClose, onMaterialSaved }) => {
    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            // 5. Gerar flashcards (OTIMIZADO: 12 flashcards)
                ...
                <div className="p-8 overflow-y-auto max-h-[calc(90vh-200px)]">
                    ...
                    {step === 'processing' && (
                        <div className="text-center py-20">
                            ...
                            <p className="text-gray-400 text-sm mt-2">Processamento otimizado - mais rápido!</p>
                        </div>
                    )}
