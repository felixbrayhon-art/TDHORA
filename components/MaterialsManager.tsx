...
import { QuizFolder, Notebook, QuizAttempt } from '../types';
...
const MaterialsManager: React.FC<MaterialsManagerProps> = ({ folders, attempts, onBack, onPlayQuiz, onCreateFolder, onCreateNotebook }) => {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          <h2 className="text-3xl font-black tracking-tighter italic uppercase flex-1">
            MEUS <span className="text-blue-500">{selectedFolderId ? 'CADERNOS' : 'MATERIAIS'}</span>
          </h2>
          {!selectedNotebookId && (
            <button 
