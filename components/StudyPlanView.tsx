...
import { StudyPlan, StudySubject, DailyHistory, StudySession } from '../types';
...
const StudyPlanView: React.FC<StudyPlanViewProps> = ({ onBack, plan, history, onUpdatePlan, onStartTimer }) => {
